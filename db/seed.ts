	...
	await db.insert(Panels).values([
		...
		// bea - Panel 4
		{
			...
			typedCaptions: [
				...
				"She loved singing but she was also developing a weapon"
			],
		},
		// bea - Panel 5
		{
		...
		// fields - Panel 11
		{
			...
			order: 11,
			imageUrl: '/xmas.mp4',
			fullStory: "Merry Christmas from the whole crew!",
			typedCaptions: [
				"Merry Xmas"
			],
		},
		...
		// ian - Panel 1
		{
			...
			typedCaptions: [
				"Ian loves skating...",
				"But he really wants to start a rock and roll band."
			],
		...
		// ian - Panel 2
		{
			...
			typedCaptions: [
				"Writing a hit song is harder than landing a kickflip.",
				"Ian’s bedroom was filled with the sounds of failure."
			],
		...
		// ian - Panel 3
		{
			...
			typedCaptions: [
				"Isabella never misses a chance to weigh in.",
				"“You can’t just invent rock greatness, Ian.”"
			],
		...
		// ian - Panel 4
		{
			...
			typedCaptions: [
				"Then a strange visitor appeared at the window.",
				"A black cat with a look that said it knew something Ian didn’t."
			],
		...
		// ian - Panel 5
		{
			...
			typedCaptions: [
				"Every time the cat meowed, the guitar sang.",
				"It was like the amp was possessed by the blues."
			],
		...
		// ian - Panel 6
		{
			...
			typedCaptions: [
				"The cousins joined in, and the sound was incredible.",
				"Bea on drums, Phin on bass, and Isa on the mic.",
				"Jam session begins."
			],
		...
		// ian - Panel 7
		{
			...
			typedCaptions: [
				"Late night in the garage, the magic was real.",
				"They finally found their sound."
			],
		...
		// ian - Panel 8
		{
			...
			typedCaptions: [
				"The neighborhood was starting to notice.",
				"“Who’s playing? That’s actually good!”"
			],
		...
		// ian - Panel 9
		{
			...
			typedCaptions: [
				"Their first street concert was pure magic.",
				"Lights, crowd, and one very special fan on the amp.",
				"Cat curled on amp tail glowing."
			],
		...
		// ian - Panel 10
		{
			...
			typedCaptions: [
				"The Midnight Strays were officially born.",
				"TO BE CONTINUED..."
			],
		...
		// isa - Panel 1
		{
			...
			typedCaptions: [
				"Isabella arrives for Christmas.",
				"Fresh from shredding snow and ready for adventure."
			],
		...
		// isa - Panel 2
		{
			...
			typedCaptions: [
				"Holiday vibes: cocoa, jokes, and chaos.",
				"Something’s brewing softly in the background."
			],
		...
		// isa - Panel 3
		{
			...
			typedCaptions: [
				"Tonight — they’re going caroling.",
				"Whether the neighborhood is ready or not."
			],
		...
		// isa - Panel 4
		{
			...
			typedCaptions: [
				"Their voices? Questionable.",
				"Their spirit? Unstoppable."
			],
		...
		// isa - Panel 5
		{
			...
			typedCaptions: [
				"Last stop — the dreaded house of Steven and Craig.",
		...
		// isa - Panel 7
		{
			...
			typedCaptions: [
				"Festive spirit meets produce warfare.",
		...
		// isa - Panel 9
		{
			...
			typedCaptions: [
				"Years of choir training finally pay off.",
				"Windows shattered. Hearts trembled."
			],
		...
		// isa - Panel 10
		{
			...
			typedCaptions: [
				"Retreat! Retreat!",
				"“Officers! The children are a menace!”"
			],
		...
		// isa - Panel 11
		{
			...
			typedCaptions: [
				"Payback — delivered by feline biological warfare.",
				"Landscaping: Brown. Honor: Restored."
			],
		...
		// isa - Panel 12
		{
			...
			typedCaptions: [
				"Peace on Earth, goodwill to kids.",
				"Merry Christmas."
			],
		...
		// john - Panel 1
		{
			...
			typedCaptions: [
				"Midshipman Marshall thought it would be an ordinary patrol.",
				"He’d soon be wrong."
			],
		...
		// john - Panel 2
		{
			...
			typedCaptions: [
				"Officer: \"Object descending fast from orbit!\"",
				"Not enemy aircraft. Not a storm. Something stranger…"
			],
		...
		// john - Panel 3
		{
			...
			typedCaptions: [
				"The first space monkey — returning to Earth.",
				"Falling toward the open sea."
			],
		...
		// john - Panel 4
		{
			...
			typedCaptions: [
				"The crew cheers...",
				"Until the monkey starts screaming."
			],
		...
		// john - Panel 5
		{
			...
			typedCaptions: [
				"The crew can’t calm him.",
				"He’s terrified. Lost. Far from home."
			],
		...
		// john - Panel 6
		{
			...
			typedCaptions: [
				"Only one thing works — bananas.",
				"Sailor: \"Did he really pack bananas?\""
			],
		...
		// john - Panel 7
		{
			...
			typedCaptions: [
				"They sit side-by-side — sailor and space traveler.",
				"Both far from home, suddenly less alone."
			],
		...
		// john - Panel 8
		{
			...
			typedCaptions: [
				...
				"Marshall: \"If I ever have a son, I am going to call him Fielding.\""
			],
		...
		// peyton - Panel 7
		{
			...
			typedCaptions: [
				"They would say many stupid things",
